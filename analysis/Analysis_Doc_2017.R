...
pointsData <- readRDS("~/share/projects/Zillow_Housing/production/Hedonics/GeneseeHedonics.rds")
...
leadsData <- read.csv("~/share/projects/Flint_Housing/production/flintLeadTest_Nov_2017/flintLeadTest_Dec_2017.csv")
...
if (WRITETOFILE)
{
  write.csv(points, file="~/share/projects/Flint_Housing/intermediate/Analysis_Nov_31_partial/analysis_1.csv", row.names = FALSE) 
}
...
if (WRITETOFILE)
{
  write.csv(points, file="~/share/projects/Flint_Housing/intermediate/Analysis_Nov_31_partial/analysis_2.csv", row.names = FALSE) 
}
...
write.csv(points, "~/share/projects/Flint_Housing/intermediate/Analysis_Nov_31_partial/points.csv", row.names = FALSE)
...
saveRDS(transactions, "~/share/projects/Flint_Housing/intermediate/expected_leadlevel_all.rds")
