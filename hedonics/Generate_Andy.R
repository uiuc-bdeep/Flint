...
{
  DB_path <- "/home/bdeep/share/projects/Zillow_Housing/stores/Zillow_2019_Sep/"
...

{
  ...
  WRITEFILE = TRUE
  print(paste0("Writing to file ", paste0(hedonics_output, state, "Hedonics_2019.rds")))
  if(WRITEFILE){
    saveRDS(finalResult, paste0(hedonics_output, state, "Hedonics_2019.rds")) #"~/share/projects/VotingBehavior/production/ILHedonics.rds")
  }
  ...
  td <- difftime(Sys.time(), ts, units = c("sec"))
  print(td)
}
# 
# ###################################
